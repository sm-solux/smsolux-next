        ...
        <section className={`relative w-full py-24 bg-[#0F1012] border-t border-white/5 overflow-hidden ${className}`}>
            <div className="container mx-auto px-6 md:px-24 h-full flex flex-col justify-center relative z-10">
                <div className="flex flex-col lg:flex-row gap-16 items-center justify-between h-full">
                    <div className="w-full lg:w-5/12 relative h-[400px] md:h-[500px] flex items-center justify-center">
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="w-40 h-40 border border-white/10 rounded-full animate-pulse-slow"></div>
                        ...
                        <div className="absolute top-0 md:top-10 bg-[#1A1B1E]/80 backdrop-blur-md border border-white/10 rounded-2xl p-5 flex items-center gap-4 shadow-xl hover:scale-105 transition-transform duration-300 animate-float-slow">
                        ...
                        <div className="absolute bottom-10 left-0 md:left-4 bg-[#1A1B1E]/80 backdrop-blur-md border border-white/10 rounded-2xl p-5 flex items-center gap-4 shadow-xl hover:scale-105 transition-transform duration-300 animate-float-delayed">
                        ...
                        <div className="absolute bottom-10 right-0 md:right-4 bg-[#1A1B1E]/80 backdrop-blur-md border border-white/10 rounded-2xl p-5 flex items-center gap-4 shadow-xl hover:scale-105 transition-transform duration-300 animate-float">
                    ...
                    <div className="w-full lg:w-6/12 space-y-8">
                        ...
                        <div className="pt-6 border-t border-white/10 grid grid-cols-3 gap-8">

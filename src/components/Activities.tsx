                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {activityList.map((item, index) => (
                        ...
                        >
                            ...
                            {/* Icon Box */}
                            <div className={`w-12 h-12 rounded-xl ${item.bg} ${item.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
                                {item.icon}
                            </div>
                            ...
                            <h3 className="text-xl font-bold text-white mb-2 flex items-center gap-2">
                                {item.korTitle}
                                {/* <span className="text-xs font-normal text-gray-500 uppercase tracking-wider ml-auto">{item.title}</span> */}
                            </h3>

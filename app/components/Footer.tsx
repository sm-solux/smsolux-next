        ...
        <footer className="w-full border-t border-white/5 py-12">
            <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                ...
                <div className="flex items-center gap-6">
                    <a href="mailto:solux@sookmyung.ac.kr" className="text-gray-400 hover:text-white transition-colors" aria-label="Email">
                    ...
                    <a href="#" className="text-gray-400 hover:text-yellow-400 transition-colors" aria-label="KakaoTalk">
